...
from envs.wrappers.multi_modal import MultiModalWrapper
...
def make_env(cfg):
	...
	if cfg.get('obs', 'state') == "multi":
		env = MultiModalWrapper(cfg, env)
		# print("multi modal:", env.observation_space.spaces)
	...
	cfg.seed_steps = max(100, 1*cfg.episode_length)
	# print("Config: ", cfg)
